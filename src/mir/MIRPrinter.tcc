...
template <std::output_iterator<char> Iterator>
MIRIteratorWriter<Iterator> &
MIRIteratorWriter<Iterator>::operator<<(instructions::IntUnaryOperator Op) {
  return operator<<(toString(Op));
}

template <std::output_iterator<char> Iterator>
MIRIteratorWriter<Iterator> &
MIRIteratorWriter<Iterator>::operator<<(instructions::IntBinaryOperator Op) {
  return operator<<(toString(Op));
}

template <std::output_iterator<char> Iterator>
MIRIteratorWriter<Iterator> &
MIRIteratorWriter<Iterator>::operator<<(instructions::FPUnaryOperator Op) {
  return operator<<(toString(Op));
}

template <std::output_iterator<char> Iterator>
MIRIteratorWriter<Iterator> &
MIRIteratorWriter<Iterator>::operator<<(instructions::FPBinaryOperator Op) {
  return operator<<(toString(Op));
}
...
Iterator dump(
  ...
  Writer << "function " << Function_ << " : " << Function_.getType()
         << Writer.linebreak() << Writer.linebreak();
  return Writer.iterator();
}
